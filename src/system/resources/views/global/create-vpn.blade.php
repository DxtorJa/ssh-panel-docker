...
@section('title', 'Create VPN - ' . $server->ip)
@section('body')
	...
	<div class="row clearfix">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                    	CREATE VPN ON SERVER {{$server->ip}}
                    </h2>
                </div>
                <div class="body">
                	<form method="post" action="/vpn/create" id="create-vpn">
                        	...
                        	<div class="row clearfix">
                                ...
                                <div class="col-sm-12">
                                    <button onclick="createVPN()" type="submit" id="btn-create-vpn" class="btn bg-teal waves-effect">CREATE</button>
                                </div>
                            </div>
                    </form>
    			</div>
